...
$w=array(25,15,25,25,25,15,15,15,15,15,15,15,15);

	//Header
   
	 $this->Cell(40);
	$this->Cell(30,20,"distributed bloods report",0,0,'C');
	$this->Ln(18);
	//Header
	 $this->Cell(20);
	...
	{ //width 
 	 	 	 $this->Cell(20);				 	
		$this->Cell(25,6,$eachResult["patient_name"],1);
		$this->Cell(15,6,$eachResult["Sex"],1);
		$this->Cell(25,6,$eachResult["P_bloodgroup"],1);
		$this->Cell(25,6,$eachResult["R_bloodgroup"],1);
		$this->Cell(25,6,$eachResult["Admitted_date"],1);
		$this->Ln();
...
$pdf=new PDF();
$header=array('Patient_name ','Sex','P_blood group ','R_blood group ','Admitted_date ');
//Data loading
//*** Load mysqli Data ***//
$objConnect = mysqli_connect("localhost","root","") or die("Error:Please check your database username & password");
$objDB = mysqli_select_db("brc");
$strSQL ="select * from bldis ";
