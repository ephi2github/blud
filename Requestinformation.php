...
<div id="all">
	...
	<h2 align=" center" >Request information</h2>
...
$result = mysqli_query($con,"SELECT * FROM dnreq");
...
?>
<form action="aprove.php" method="POST"><input type="hidden" name="id" value="<?php echo $row[0]; ?>">
