                                                            ...
                                                            <div id="header" ><?php include("openpage.php");?></div>
                                                             <div id="main_container">
																									...
																									$_SESSION['reYear']=$reYear;
																										...
																										($reMonth=="SelectMonth")||($reDate=="SelectDate")||($reYear=="SelectYear")) header("Location:Reservation2.php?emptyy");
																										  else{
																											 //validate name
																											$name = preg_replace('/[\s]+/is', ' ',$name);
																											$name = trim($name);
																											if(!preg_match('/^[a-z\s]+$/i', $name))header("Location:Reservation2.php?name");
																											 else{
																											 //check the phone number
																											  if(!preg_match("/^[+]{1}[0-9]{3}-[0-9]{3}-[0-9]{6}$/", $phone))header("Location:Reservation2.php?phone");
																											 else{
																										   ...
																										   // check pick update and return date
																											//..............................................................
																														 ...
																														 $insert="INSERT INTO  appointment (First  Name,Last Name,Unique Name,Sex,
																														 Telephone,Email,Country,Date of birth ,Age,apointment time,Appointment date)VALUES
																														   ('$First  Name','$Last Name','$Unique Name','$Sex','$Telephone','$Email','$Country','$Date of birth ','$Age ','$apointment time ','$Appointment date')";
	                                                                                                               ...
	                                                                                                               //echo "SUCESSFULLY SENT";																														
																														echo "<fieldset class=\"loginField\">
																														 ...
																														 <tr><td>You are sucessfully reserved! Your Reservation id is=<font color=\"red\">$reservationid</font></td></tr>
																														  ...
																														  <tr><td>Donot forget your<font color=\"red\"> reservation id</font> it is necessary during ,for update reservation and Cancel reservation unless we cannot serve you!</td></tr>
