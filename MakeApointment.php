...
<div id="all">
  <div id="banner"> <img height="100%"width="100%"src="banner.JPG"></div>
	...
	<div><?php echo "You are here".">"."<font color='red'>Resevation</font>"?></div>
<div id="main_container">
   <div id="left_content"  >
<form action="ReservationServer.php" method="post">
 
 <fieldset class="loginField">
<table cellspacing="3" cellpadding="6" class="loginVerticalPanel">
 
<tr>
  <td colspan="2"><?php if(isset($_GET['reserve'])) echo "<center><font color=\"green\">You are Sucessfully Reserve Vehicle</font></center>";?> <strong>make appointment heare </strong></td>
</tr>
<tr><td>Full Name</td><td   colspan=""> <input size="40" height="80" type="text" name="name" /></td></tr>
...
<option value="Zimbabwe">Zimbabwe</option>
   ...
   <!-- pick up date-->
   <tr><td colspan="2"><?php if(isset($_GET['unbalanceddate'])) echo "<center><font color=\"red\">Pick up date must be less than return date</font></center>";?> </td></tr>
<tr>
  <td>apointment day <div align="right"></td>
 ...
 <select name="PDay">
  ...
  <!-- Return Date-->
<tr><td>Return Date</td><td><select name="ReMonth">
      <?php 
      $month=array("January","Febuary","March","April","May","June","July","August","September","October","November","December");
      echo "<option value=\"SelectMonth\">SelectMonth</option>";for($i=0;$i<=11;$i++) echo "<option value=\"$month[$i]\">$month[$i]</option>"; 
      ?>
...
<select name="ReDay">
 ...
 <select name="ReYear">
        <?php echo "<option value=\"SelectYear\">SelectYear</option>";for($i=2012;$i<=2099;$i++) echo "<option value=\"$i\">$i</option>"; ?>
            ...
            <tr><td><div align="right">Return Time: </div></td>
            <td><select name="return_hr" >
	              <option value="1">1</option>
    	          <option value="2">2</option>
        	      <option value="3">3</option>
            	  <option value="4">4</option>
 ...
 <tr><td colspan="3" align="center"> <input size="300"type="submit" class="submit" value="Reseve Now"/></td></tr>
  </table>
</fieldset>
