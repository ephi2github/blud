...
$stufogotpass = mysqli_query($con,$query_stufogotpass) or die( mysqli_error($con));
...
if($_POST['password'] == $_POST['confirmpass']){
	mysqli_query($con,"UPDATE account set password='". $_POST['confirmpass']."' WHERE username='" . $_POST['username'] . "' && password='" . $_POST['code'] . "'");
