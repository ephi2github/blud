...
<form action="empupdate.php" method="post">
  ...
  <tr><td bordercolor="#993366" bgcolor="#9900CC"><label>&nbsp;&nbsp;&nbsp;&nbsp;<span class="style1"> <span class="style3"> Search Employee Information </span>&nbsp;&nbsp; </span><br>
        <br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
  &nbsp;&nbsp; &nbsp;<span class="style1">&nbsp;<span class="style3"> Employee Id</span></span></label>
      <span class="style1">
      <select name="select">
          <?php
