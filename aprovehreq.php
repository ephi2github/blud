...
<div id="all">
	...
	<div id="main_container">
		...
		<form action="aprovehreq.php" method="POST"><input type="hidden" name="id" value="<?php echo $row[0]; ?>"> 
		  <?php
$id=$_POST['id'];
...
<td><input type="text"name="mname" value="<?php echo $row[2];?>"></td>
</tr>
<tr>
  <td align="right">Last name</td>
<td><input type="text"name="lname" value="<?php echo $row[3];?>"></td>
</tr>
<tr>
