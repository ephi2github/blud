...
<div id="main_container">
   <div id="left_content"  >
<form action="addbloodserv.php" method="post" onSubmit="MM_validateForm('id','','R','fname','','R','mname','','R','lname','','R','uname','','R','city','','R','tel','','NisNum','email','','R','salary','','NisNum','dpt','','R','specfic','','R','paw','','R');return document.MM_returnValue">
...
<tr><td align="right">Amount needed</td><td> <input type="text" name="aneed" min="1" pattern="[0-9]{1,10}" placeholder='amount' required title="Amount must be number"></td></tr>   
...
<tr><td align="right">Expired date</td>
 ...
 <tr><td  align="center"> <input size="100"type="submit" class="submit" value="Add"/></td>
