...
<tr>
  <td colspan="2"><?php if(isset($_GET['reserve'])) echo "<center><font color=\"green\">You are Sucessfully make apointment</font></center>";?> <strong>make appointment heare </strong></td>
</tr>
<tr>
  <td>First  Name</td>
  <td   colspan=""> <input size="40" height="80" type="text" name="name" /><label></label></td></tr>
  <tr><td>Last Name</td><td> <input type="text" name="name"></td></tr>
    <tr><td>Unic Name</td><td> <input type="text" name="name"></td></tr>
  <tr><td>Sex</td><td> <input type="text" name="name"></td></tr>
...
<select name="ReDay">
 ...
 <tr><td  align="center"> <input size="300"type="submit" class="submit" value="apointed now"/></td>
<td colspan="3" align="center"> <input size="300"type="reset" class="submit" value="clear"/></td></tr>
  </table>
</fieldset>
