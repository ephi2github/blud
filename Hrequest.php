...
<div id="main_container">
   <div id="left_content"  >
<form action="hrequestserv.php" method="post" onSubmit="MM_validateForm('id','','R','fname','','R','mname','','R','lname','','R','uname','','R','city','','R','tl','','NisNum','email','','RisEmail','woreda','','R','kbl','','R','bgrp','','R','paw','','R');return document.MM_returnValue">
<table cellspacing="3" cellpadding="6" class="loginVerticalPanel">
 
<tr>
  <td colspan="2"><?php if(isset($_GET['reserve'])) echo "<center><font color=\"green\">You are Sucessfully make apointment</font></center>";?><strong> Hospital request Form </strong></td>
</tr>
  ...
  <tr><td align="right">Age</td><td> <input type="number" name="age" min="1" max="100" placeholder='age' title="Age must be number" required></td></tr>
<tr><td align="right">Hospital Name</td><td> <select name="hname" required title="select hospital name"> 
...
<option value="Union kefitegna kedotigena clinic">Union kefitegna  clinic</option> 
   ...
   <!-- pick up date-->
   <tr><td colspan="2"><?php if(isset($_GET['unbalanceddate'])) echo "<center><font color=\"red\"> </font></center>";?> </td></tr>
      
   <tr><td align="right">telephone</td><td> <input type="text" name="tel"  pattern="[+]{1}[2]{1}[5]{1}[1]{1}-[5]{1}[8]{1}[0-9]{1}-[0-9]{6}" required x-moz-errormessage="Please Enter valid phone number"  placeholder='telephone' title="Please Enter valid phone number"></td></tr>
   <tr><td align="right">Email</td><td> <input type="text" name="email" required placeholder='email'title="Please Enter valid Email"></td></tr>
   <?php if(isset($_GET['fail']))echo "<center><font color=\"red\">curent date nmust be less than apointment date </font></center>";?>
   <tr><td align="right">Required Blood group</td><td><select name="bgrp" required title="select Required Blood group">
   ...
   <tr><td align="right">Amount needed</td><td> <input type="text" name="aneed" min="1" pattern="[0-9]{1,5}" placeholder='amount' required title=""></td></tr>
  </table>
